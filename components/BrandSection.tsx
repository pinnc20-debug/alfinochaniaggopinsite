        ...
        <div className={`flex flex-col md:flex-row items-center gap-8 md:gap-16 ${isLeft ? '' : 'md:flex-row-reverse'}`}>
          ...
          <div className="w-full md:w-1/2 space-y-5 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-6">
              <div className="p-3 md:p-4 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-1">
                    <Cpu className={`w-5 h-5 md:w-8 md:h-8 ${data.accentColor}`} />
              ...
              <div className="p-3 md:p-4 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-1">
                    <Smartphone className={`w-5 h-5 md:w-8 md:h-8 ${data.accentColor}`} />
              ...
              <div className="p-3 md:p-4 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition-shadow sm:col-span-2">
                <div className="flex items-center gap-3 mb-2">
                    <Activity className={`w-5 h-5 md:w-8 md:h-8 ${data.accentColor}`} />

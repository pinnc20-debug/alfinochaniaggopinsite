...
export const Header = ({ currentView, onNavigate }: HeaderProps) => {
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, id: string) => {
    ...
    if (element) {
      ...
      // Di mobile kita memberikan sedikit extra offset agar kapsul tidak menutupi judul bagian
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center py-2 md:py-0 md:h-20 relative">
          ...
          <div className="hidden md:flex items-center space-x-4 z-50">
             <a href="https://github.com" target="_blank" rel="noreferrer" className="flex items-center justify-center w-9 h-9 rounded-full bg-gray-50 text-gray-400 hover:bg-gray-900 hover:text-white transition-all">
